...
# t1_start
plot(airquality$Temp, airquality$Ozone, xlab = "Temperatur  [\U{00B0}Fahrenheit]", 
     ylab = "\U00D8 Ozon  [ppb]", xlim = c(50,100), ylim = c(0,200),
     main = "Mehr Ozon an warmen Tagen", 
     col ="#FFA50080", pch = 16, cex = airquality$Wind/5, las = 1)
# t1_ende
...
# t4_start
text(x = 78, y = 115,labels = "30. Mai", pos = 4, adj = 1)
# t4_ende
...
# t5_start
legend("topleft", legend = leg_wind, title = "Windgeschwindigkeit  [mph]", 
       col = "orange", pch = 16, pt.cex = leg_wind/5)
# t5_ende
