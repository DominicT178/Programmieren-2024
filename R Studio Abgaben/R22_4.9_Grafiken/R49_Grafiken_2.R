...
# t6_start
boxplot(esoph$ncontrols, outline = FALSE, range = 0)
# t6_ende
...
# t7_start
output_hist <- hist(airquality$Temp,freq = FALSE, breaks = 15, col = "coral", 
                    xlim = c(50, 100),
                    xlab = "Temperatur  [\U{00B0}F]", main = "Histogramm der Tageshöchsttemperaturen")
# t7_ende
